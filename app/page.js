...
//             Track shared expenses, split bills effortlessly, and settle up quickly. Never worry about who owes what again.
//           </p>
...
//             <Button asChild variant="outline" size="lg" className="border-green-600 hover:bg-green-600 hover:bg-green-50">
...
//           <div className="container mx-auto max-w-5xl overflow rounded-xl shadow-xl">
...
//             Everything you need to split expenses seamlessly.
//           </h2>
...
//             {FEATURES.map(({title, description, Icon, bg, color}, index) => (
//               <Card
//                 key={title}
...
//           <h2 className="gradient-title mt-2 text-3xl md:text-4xl">
//             Splitting expensses has never been easier.
//           </h2>

//           <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed">
//             Follow these simple steps to get started with splitting expenses with friends.
//           </p>
